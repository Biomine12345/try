...
// Config
$config = new Config();
$config->load('default');    //load htdocs/system/config/default.php
$config->load($application_config);//load htdocs/system/config/catalog.php
...
if ($config->has('action_event')) {
	foreach ($config->get('action_event') as $key => $value) {
		$event->register($key, new Action($value));      //htdocs/catalog/controller/event/compatibility.php
	}
}
...
// Pre Actions
if ($config->has('action_pre_action')) {   //htdocs/catalog/startup/seo_url.php and so on
